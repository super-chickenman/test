...
import manager_jar.font.AdminRegController;
...
public class Admin extends Application {
    ...
    public void initreg() throws IOException {
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("/manager_jar/fxml/register_manager.fxml"));
        AnchorPane root = loader.load();
        Scene scene = new Scene(root);

        Stage regStage = new Stage();

        regStage.setTitle("管理员注册界面");
        regStage.setScene(scene);

        AdminRegController controller = loader.getController();
